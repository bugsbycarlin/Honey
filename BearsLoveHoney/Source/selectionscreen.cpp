...
void SelectionScreen::initializeAssets() {
...
void SelectionScreen::initializeLogic() {
...
void SelectionScreen::initializeInput() {
  // Set action keys
...
void SelectionScreen::logic() {
  ...
  if (input.keyPressed("return")) {
    string left_bear = bears[selected_bear + 1 + bears.size() % bears.size()];
    string right_bear = bears[selected_bear - 1 + bears.size() % bears.size()];
    string middle_bear = bears[selected_bear];
    unique_ptr<Screen> game_screen(new GameScreen(left_bear, right_bear, middle_bear, bear_colors[selected_bear]));
    screenmanager.addScreen("game_screen", game_screen);
